...
class SpampedeDisplay {
	...
	public void updateGraphics() {
		...
		int shiftX = (this.width - Preferences.NUM_CELLS_WIDE*cellSize)/2;
		int shiftY = 50;
		for (int i = 0; i < this.theData.getNumColumns(); i++) {
			for (int j = 0; j < this.theData.getNumRows(); j++) {
				this.drawSquare(cellSize*i +shiftX,cellSize*j+shiftY,this.theData.getCellColor(j, i));
			}
		}
